...
const CreateSurvey = ({ route }) => {
  ...
  const handleSubmitSurvey = () => {
    ...
    if (isSurveyTypeValid && isEndTimeValid && areQuestionsValid) {
      ...
      navigation.navigate('CreateTeacher', { surveyType, endTime: endTime.toISOString(), questions, hideInvitationButton: true });
    } else {
    ...
    <>
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        ...
        <IconButton
          ...
          style={styles.addButton}
        />
        <Button mode="contained" style={{ marginTop: 50 }} onPress={handleSubmitSurvey}>
          Hoàn tất
        </Button>
      </ScrollView>
    </>
