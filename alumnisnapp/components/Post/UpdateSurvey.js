...
const UpdateSurvey = ({ route }) => {
  ...
  const handleSubmitSurvey = async () => {
    ...
    try {
      ...
      await api.put(`/survey/${post.id}/`, payload);
      ...
      navigation.navigate("UpdatePostScreen", {
        ...
        questions,
        post,
        origin: "UpdateSurveyScreen",
      });
    } catch (error) {
      console.error("Error updating survey:", error);
      Alert.alert("Lỗi", "Cập nhật khảo sát thất bại, vui lòng thử lại.");
    }
  };
  ...
  return (
    <ScrollView contentContainerStyle={{ padding: 16 }}>
        ...
        <View key={question.id} style={styles.questionContainer}>
          ...
          {question.options.map((option) => (
            <View key={option.id} style={styles.optionContainer}>
              <TextInput
                ...
                value={option.option}
                onChangeText={(text) =>
                  handleOptionChange(text, question.id, option.id)
                }
          ...
          <View style={styles.switchContainer}>
            ...
            <Switch
              ...
              onValueChange={(value) =>
                handleMultiChoiceChange(value, question.id)
              }
            />
          </View>
        </View>
      ...
      <Button
        mode="contained"
        style={{ marginTop: 50, backgroundColor: "#2563eb" }}
